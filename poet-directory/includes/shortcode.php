    ...
    <div class="poet-directory" dir="rtl" lang="he">
        <section class="poet-hub">
            ...
            <p class="poet-hub-lead">
                POET (פריש ורוזנבלום, 2020) היא התערבות מבוססת ראיות מחקריות שפותחה באוניברסיטת חיפה לשיפור התפקוד והתפקודים הניהוליים של ילדים עם תסמיני ADHD.
            </p>

            <div class="poet-hub-grid">
                <article>
                    <h3>מטרות נבחרות על ידי ההורים, בהתאם למה שחשוב להם</h3>
                    <ul>
                ...
                <article>
                    ...
                    <h3>מי מיישם את הגישה?</h3>
                    <p>ה-POET מיושמת אך ורק על ידי מרפאים/ות בעיסוק עם רישיון משרד הבריאות שעברו קורס הכשרה מקצועית בגישת POET ועמדו בכל דרישותיו.</p>
                </article>
            </div>
